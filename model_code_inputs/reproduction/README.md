...
`input_reference_model.prm` is the ASPECT Input file for reference model discussed in paper. Input file has been updated for compatibility with more recent ASPECT versions. Input file tested on ASPECT version 2.6.0-pre (fix_stresses_elasticity, 621dd61f2), using deal.II 9.4.2.
